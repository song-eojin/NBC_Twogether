...
public class DeckController {
    ...
    public ResponseEntity<ApiResponseDto> addDeck(@PathVariable Long boardId, @RequestBody String title) {
    ...
    @PutMapping("/decks/{id}")
    public ResponseEntity<ApiResponseDto> editDeck(@PathVariable Long id, @RequestBody String title) {
    ...
    public ResponseEntity<ApiResponseDto> archiveDeck(@PathVariable Long id) {
    ...
    public ResponseEntity<ApiResponseDto> deleteDeck(@PathVariable Long id) {
    ...
    public ResponseEntity<ApiResponseDto> moveDeck(@PathVariable Long id, @RequestBody
